...
if ($_GET && key_exists('mfn-rtl', $_GET)):
    ...
    <head>
        ...
        <script>(function (w, d, s, l, i) {
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-PLPWR53');</script>
        ...
        <title itemprop="name"><?php
            if (mfn_title()) {
                ...
                bloginfo('name');
                if ($paged >= 2 || $page >= 2)
                    echo ' | ' . sprintf(__('Page %s', 'betheme'), max($paged, $page));
            }
            ?></title>
    ...
    <body <?php body_class(); ?>>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLPWR53"
